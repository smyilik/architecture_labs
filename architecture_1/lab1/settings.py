...
SECRET_KEY = 'django-insecure-)zp=0ojy8c0e@vaz=_l25^fnh($7^jd3!%$+a7%iwe^pez)dxe'
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',  # внутренний пользователь БД, нужно создать вручную или отдельным скриптом
        'PASSWORD': 'qq228', # пароль этого пользователя
        'HOST': 'localhost',
        'PORT': 5432,
    },
}
